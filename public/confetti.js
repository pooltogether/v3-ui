...
ConfettiPaper.bounds = new Vector2(window.innerWidth, window.innerHeight);
...
confettiCtx.ConfettiClass = function (className, debug) {
  var i = 0;
  ...
  this.update = function () {
    ...
    this.interval = rAF(function () {
      if (confettiClass && confettiClass.update) {
        confettiClass.update();
      } else {
        console.error('confettiClass not defined?')
      }
    });
  }
}
