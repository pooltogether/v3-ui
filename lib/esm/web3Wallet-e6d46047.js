...
import { m as metamaskIcon, a as metamaskIcon2x } from './icon-metamask@2x-0a28b51f.js';

function web3Wallet(options) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                provider = window.ethereum || window.web3 && window.web3.currentProvider; // await ethereum.enable() // TODO: This is deprecated and shouldn't be necessary but fixes Brave for some people
