...
import { usePrizePoolsLockedValue } from 'lib/hooks/usePrizePoolsLockedValue'
import { ethers } from 'ethers'

export const useTotalPoolPrizeValueLockedUSD = () => {
  const { data: prizePools, isFetched: prizePoolsIsFetched } = usePrizePoolsLockedValue()
  ...
  return useMemo(() => {
    ...
    prizePools.forEach((prizePool) => {
      ...
      console.log(poolPrizeTotalValueLockedUSD, poolPrizeTotalSponsorshipValueLockedUSD)
