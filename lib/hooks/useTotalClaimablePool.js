...
// TODO: Again, ideally this data is just shared from the other components
...
async function getTotalClaimablePool (provider, usersAddress, comptrollerAddresses) {
  ...
  comptrollerAddresses.forEach(comptrollerAddress => {
    ...
    batchCalls.push(comptrollerContract.userStates(usersAddress))
  })
  ...
  console.log(comptrollerResponse)
