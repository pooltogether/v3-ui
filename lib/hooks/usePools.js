...
const getPool = async (chainId, poolAddress) => {
  let r = await fetchData(`https://pooltogether-api.com/pools/${chainId}/${poolAddress}.json`)
  const q = { ...r }
  console.log(r, deserializeBigNumbers(q))
}
