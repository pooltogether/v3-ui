...
const getMaxTimelockDurationSeconds = async (provider, pool, exitFee, usersTicketData) => {
  ...
  console.log('getMaxTimelockDurationSeconds', maxTimelockDurationSeconds)
  ...
  console.log(
    'getMaxTimelockDurationSeconds 2',
    response[prizePoolAddress].estimateCreditAccrualTime[0].toString()
  )
