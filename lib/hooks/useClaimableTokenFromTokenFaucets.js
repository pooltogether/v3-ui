...
export const useClaimableTokenFromTokenFaucets = (usersAddress) => {
  ...
  return useQuery(
    [QUERY_KEYS.claimablePoolFromTokenFaucets, usersAddress, appEnv],
    async () => {
      return getClaimableTokensFromTokenFaucets(readProviders, pools, usersAddress)
    },
    {
      enabled,
...
async function getClaimableTokensFromTokenFaucets(readProviders, pools, usersAddress) {
  ...
  console.log('claimableAmounts', claimableAmounts)
