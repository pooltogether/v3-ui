...
export const marshallPoolData = (daiGraphData) => {
  ...
  const ticketToken = getControlledToken(daiGraphData?.controlledTokens, actualStrategy?.ticket)
  const sponsorshipToken = getControlledToken(daiGraphData?.controlledTokens, actualStrategy?.sponsorship)
