...
export const fetchExitFees = async (
  ...
  try {
    ...
    console.log('exitFee', values.prizePool.calculateEarlyExitFee.exitFee.toString())
    console.log('durationSeconds', values.prizePool.calculateTimelockDuration.durationSeconds.toString())
