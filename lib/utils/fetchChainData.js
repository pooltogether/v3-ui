...
//       // don't need to get this from infura!
...
export const fetchChainData = async (
  ...
  fetchGenericChainValues(provider, pool, setGenericChainValues)

  if (usersAddress) {
    fetchUsersChainValues(provider, usersAddress, pool, setUsersChainValues)
  }
}
