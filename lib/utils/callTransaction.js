...
export const runAsyncTx = async (
  ...
  try {
    ...
    // TODO: The following lines until the `catch` should be moved
    // if they error out while the tx succeeded the user will see an error
    // even though the tx succeeded!
    if (refetchQuery) {
