  ...
  for (i = 0; i < awards?.length; i++) {
    ...
    batchCalls.push(
      etherplexTokenContract
        ...
        .name() // replace this with data from the graph external awards query
        .symbol() // replace this with data from the graph external awards query
        // .decimals() // replace this with data from the graph external awards query
    )
  }
