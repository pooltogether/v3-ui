...
const _getUsersV2Data = async (chainId, provider, usersAddress, contractAddresses) => {
...
// TODO: this needs to be split up into 3 separate queries!
export const fetchUsersChainData = async ({
  ...
  // try {
    ...
    usersV2Data = await _getUsersV2Data(chainId, provider, usersAddress, contractAddresses)
