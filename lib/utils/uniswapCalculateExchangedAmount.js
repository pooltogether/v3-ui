...
export function uniswapCalculateExchangedAmount(inputAmountBN, exchangeRate, underlyingCollateralDecimals) {
  let normalizedExchangedBN = bn(0)

  const decimalPrecisionDiff = DEFAULT_TOKEN_DECIMAL_PRECISION - underlyingCollateralDecimals
