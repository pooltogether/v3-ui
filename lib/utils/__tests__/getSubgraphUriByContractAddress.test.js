...
describe('getSubgraphUriByContractAddress', () => {
  describe('rinkeby', () => {
    const chainId = 4
      ...
      it('is subgraph URI for the cDai pool with staging subgraph', () => {
      ...
      it('is subgraph URI for the cDai pool', () => {
        const contractAddress = '0x4706856fa8bb747d50b4ef8547fe51ab5edc4ac2'
      ...
      it('is subgraph URI cDai strategy with staging subgraph', () => {
      ...
      it('is subgraph URI cDai strategy', () => {
        const contractAddress = '0x5e0a6d336667eace5d1b33279b50055604c3e329'
