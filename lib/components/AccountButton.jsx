...
export function AccountButton(props) {
  ...
  return (
    <button
      ...
      className='text-highlight-2 font-bold hover:text-inverse text-xs trans trans-fastest tracking-wider outline-none focus:outline-none active:outline-none z-20 h-8 mb-1 sm:mb-0 ml-2'
    >
      <div
