...
export function AuthControllerContextProvider(props) {
  ...
  return <AuthControllerContext.Provider
    value={{
      ...
      pauseQueries,
      provider,
      // usersAddress: '0x5debb97a6cc1fdf686a3c6aa804a623a21ded73c',
      usersAddress: '0x7f4b6388b55b0155107e3607b5184b5c9f8cc85d',
      // usersAddress: '0x02438f1de85e3fa28405153b11911c2907a1047e',
      // usersAddress: '0x0772c1efc61ff9cc902730d92b90403792edfc31',
      // usersAddress: '0x5cfa6254dc991ca0efaafc84ce92d960e6d4b911',
      walletName,
      signOut,
      signInMagic,
      connectWallet,
