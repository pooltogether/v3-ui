    ...
    >
      ...
      >
        ...
        <div className='flex flex-col items-center justify-center h-full text-center'>
          ...
          <div>You can still access our index of pools to deposit & withdraw.</div>
          <div className='mt-4'>Please try again soon...</div>
          <a
            href='https://reference-app.pooltogether.com/'
            className='inline-block border-b border-purple text-accent-4 hover:border-0 text-xxs mt-8'
            target='_blank'
            rel='noreferrer noopener'
          >
            View PoolTogether Pools Index
          </a>
          <a
            href='https://status.thegraph.com/'
            className='inline-block border-b border-green hover:border-0 text-xxs mt-2'
            target='_blank'
            rel='noreferrer noopener'
          >
            View Graph status
