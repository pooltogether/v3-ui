...
const V2Ticket = (props) => {
  ...
  return (
    <div className='bg-accent-grey-4 py-2 rounded-lg relative text-xxxs sm:text-xs mb-3 flex flex-row'>
      <div className='flex flex-col justify-center text-center border-accent-3 border-dashed border-r-2 h-24 w-32 sm:w-40'>
      ...
      <div className='flex w-full justify-between px-8'>
        ...
        <div className='text-right flex flex-col my-auto'>
          <span className='text-xs text-accent-1 font-bold mb-1'>
